...
#define require_action_quiet    __Require_Action_Quiet
#define require_quiet           __Require_Quiet
...
/*
 ...
 A birthday present every eleven wallets? The security of customer-chosen banking PINs (2012),  by Joseph Bonneau , SÃ¶ren Preibusch , Ross Anderson
 */
...
static void getUniformRandomNumbers(uint8_t* buffer, size_t numberOfDesiredNumbers, uint8_t upperBound)
{
    ...
    // where our smaller range doesnâ€™t evenly divide in to [0, 255]. For example, with the desired range of [0, 54]
